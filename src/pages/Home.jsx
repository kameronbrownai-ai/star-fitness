...
const faqs = [
  ...
  { q: 'What sports is the Star Mat designed for?', a: 'The Star Mat is built for multi-sport athletes: Football, Basketball, Soccer, Baseball and Softball, Track & Field, Pickleball, Tennis, Golf, Hockey, Lacrosse, and MMA/Combat Sports. Each sport has specific training programs targeting the key body areas and movements that matter most for performance and staying resilient.' },
