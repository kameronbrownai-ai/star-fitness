...
const products = [
  // Mats
  { id: 1, name: 'Star Mat Pro 2.0', price: 199, originalPrice: 229, category: 'Mats', badge: 'Best Seller', badgeColor: '#007AFF', rating: 4.9, reviews: 2847, accent: '#007AFF', gradient: 'from-blue-900/60 to-star-black', emoji: '🧘', image: '/images/mat-clean.jpeg', desc: '8mm premium TPE foam, two-sided print, peg-hole anchoring, carry strap included.', features: ['8mm Cushion', 'Two-Sided Print', 'Peg-Hole Anchoring', 'Carry Strap'] },
  { id: 2, name: 'Star Mat Lite', price: 149, originalPrice: null, category: 'Mats', badge: 'New', badgeColor: '#30D158', rating: 4.7, reviews: 1204, accent: '#30D158', gradient: 'from-green-900/40 to-star-black', emoji: '🧘', image: '/images/mat-clean.jpeg', desc: '4mm travel mat. Single-sided print, no anchoring, lightweight and foldable.', features: ['4mm Cushion', 'Single-Sided Print', 'Foldable', 'Lightweight'] },
  // Accessories
